...
// MODIFIED to support more javascript syntax, copying syntax from: https://github.com/pegjs/pegjs/blob/master/examples/javascript.pegjs
...
member
  = name:member_name name_separator value:value value_separator? {
